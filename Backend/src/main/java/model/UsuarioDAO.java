...
public class UsuarioDAO {
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Usuario) session.load(model.Usuario.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int id) throws PersistentException {
		try {
			return (Usuario) session.get(model.Usuario.class, new Integer(id));
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario loadUsuarioByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.load(model.Usuario.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static Usuario getUsuarioByORMID(PersistentSession session, int id, org.hibernate.LockMode lockMode) throws PersistentException {
		try {
			return (Usuario) session.get(model.Usuario.class, new Integer(id), lockMode);
		}
		catch (Exception e) {
			e.printStackTrace();
			throw new PersistentException(e);
	...
	public static List queryUsuario(PersistentSession session, String condition, String orderBy) throws PersistentException {
		StringBuffer sb = new StringBuffer("From model.Usuario as Usuario");
		if (condition != null)
	...
	public static boolean save(model.Usuario usuario) throws PersistentException {
		try {
			ProyectoVPPPersistentManager.instance().saveObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean delete(model.Usuario usuario) throws PersistentException {
		try {
			ProyectoVPPPersistentManager.instance().deleteObject(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean deleteAndDissociate(model.Usuario usuario)throws PersistentException {
		try {
			model.Pregunta[] lPreguntass = usuario.preguntas.toArray();
			for(int i = 0; i < lPreguntass.length; i++) {
				lPreguntass[i].setUsuario(null);
			}
	...
	public static boolean deleteAndDissociate(model.Usuario usuario, org.orm.PersistentSession session)throws PersistentException {
		try {
			model.Pregunta[] lPreguntass = usuario.preguntas.toArray();
			for(int i = 0; i < lPreguntass.length; i++) {
				lPreguntass[i].setUsuario(null);
	...
	public static boolean refresh(model.Usuario usuario) throws PersistentException {
		try {
			ProyectoVPPPersistentManager.instance().getSession().refresh(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
	...
	public static boolean evict(model.Usuario usuario) throws PersistentException {
		try {
			ProyectoVPPPersistentManager.instance().getSession().evict(usuario);
			return true;
		}
		catch (Exception e) {
			e.printStackTrace();
