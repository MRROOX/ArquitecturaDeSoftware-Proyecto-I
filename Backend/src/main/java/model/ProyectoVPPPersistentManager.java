...
public class ProyectoVPPPersistentManager extends PersistentManager {
	private static final String PROJECT_NAME = "ProyectoVPP";
	...
	private ProyectoVPPPersistentManager() throws PersistentException {
	...
	public static synchronized final PersistentManager instance() throws PersistentException {
		if (_instance == null) {
			_instance = new ProyectoVPPPersistentManager();
		}
